Feature: the user can create and retrieve the books
  Scenario: user creates two books and retrieve both of them
    When the user creates the book "Les Misérables" written by "Victor Hugo" reserved is "false"
    And the user creates the book "L'avare" written by "Molière" reserved is "false"
